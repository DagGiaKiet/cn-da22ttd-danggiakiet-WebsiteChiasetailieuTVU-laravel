  ...
  <div class="bg-white dark:bg-gray-800 shadow rounded-lg border border-gray-200 dark:border-gray-700">
    ...
    <div class="px-6 py-4">
      ...
      <div class="flex justify-between items-center mb-4">
        <div class="relative">
          <input type="text" placeholder="Tìm kiếm sinh viên..." class="pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
            ...
            @foreach($users as $u)
              ...
              <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                  @if(auth()->id() === $u->id)
                    <span class="text-gray-400 dark:text-gray-500">(Tài khoản của bạn)</span>
                  @else
