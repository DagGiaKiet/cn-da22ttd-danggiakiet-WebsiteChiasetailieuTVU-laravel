...
<div class="w-full py-4 px-4 sm:px-6 lg:px-8">
  ...
  <div class="bg-white shadow rounded-lg">
    <div class="p-6 border-b border-gray-200 flex items-center justify-between">
      <div>
        <h2 class="text-xl font-semibold text-gray-900">Bài viết của tôi</h2>
        <p class="mt-1 text-sm text-gray-500">Danh sách bài viết bạn đã đăng</p>
      </div>
          ...
          @forelse($blogs as $b)
            <tr>
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                 <a href="{{ route('blogs.show', $b) }}" class="text-blue-600 hover:underline">Xem</a>
              </td>
            </tr>
          @empty
            <tr>
              <td colspan="4" class="px-6 py-4 text-sm text-center text-gray-500">Bạn chưa đăng bài viết nào.</td>
            </tr>
          @endforelse
        </tbody>
      </table>
